...
def lightgbm_cv_func(data, target, pbounds):
   ...
   # 执行超参数搜索
    ...
    print(best_params,'best_paramslightgbm')
    # best_params = best_params['params']
    best_params['estimator__max_depth'] = int(best_params['estimator__max_depth'])
    best_params['estimator__n_estimators'] = int(best_params['estimator__n_estimators'])
    return best_params
